...
class Init_SetLed_Request_led_states
{
public:
  explicit Init_SetLed_Request_led_states(::my_robot_interfaces::srv::SetLed_Request & msg)
  : msg_(msg)
  {}
  ::my_robot_interfaces::srv::SetLed_Request led_states(::my_robot_interfaces::srv::SetLed_Request::_led_states_type arg)
  {
...
public:
  ...
  {}
  Init_SetLed_Request_led_states led_number(::my_robot_interfaces::srv::SetLed_Request::_led_number_type arg)
  {
    msg_.led_number = std::move(arg);
    return Init_SetLed_Request_led_states(msg_);
  }
