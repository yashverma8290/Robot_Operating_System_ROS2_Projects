...
class SetLed_Request(metaclass=Metaclass_SetLed_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.led_states = kwargs.get('led_states', int())
    ...
    def led_states(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'led_states' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'led_states' field must be an integer in [-9223372036854775808, 9223372036854775807]"
