...
class HardwareStatus(metaclass=Metaclass_HardwareStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.dubug_message = kwargs.get('dubug_message', str())
    ...
    def __eq__(self, other):
        ...
        if self.are_motors_ready != other.are_motors_ready:
            return False
        if self.dubug_message != other.dubug_message:
            return False
        return True
    ...
    def temprature(self, value):
        if self._check_fields:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'temprature' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
    ...
    @builtins.property
    def dubug_message(self):
        """Message field 'dubug_message'."""
        return self._dubug_message

    @dubug_message.setter
    def dubug_message(self, value):
        if self._check_fields:
            assert \
                isinstance(value, str), \
                "The 'dubug_message' field must be of type 'str'"
        self._dubug_message = value
