...
bool my_robot_interfaces__msg__hardware_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // temprature
    ...
    ros_message->temprature = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // are_motors_ready
  ...
  {  // dubug_message
    PyObject * field = PyObject_GetAttrString(_pymsg, "dubug_message");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->dubug_message, PyBytes_AS_STRING(encoded_field));
...
PyObject * my_robot_interfaces__msg__hardware_status__convert_to_py(void * raw_ros_message)
{
  ...
  {  // dubug_message
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->dubug_message.data,
      strlen(ros_message->dubug_message.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "dubug_message", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
