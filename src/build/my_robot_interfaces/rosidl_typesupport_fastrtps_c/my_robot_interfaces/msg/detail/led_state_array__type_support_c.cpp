  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const my_robot_interfaces__msg__LedStateArray * ros_message = static_cast<const my_robot_interfaces__msg__LedStateArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_my_robot_interfaces__msg__LedStateArray(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  my_robot_interfaces__msg__LedStateArray * ros_message = static_cast<my_robot_interfaces__msg__LedStateArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_my_robot_interfaces__msg__LedStateArray(cdr, ros_message);
}
