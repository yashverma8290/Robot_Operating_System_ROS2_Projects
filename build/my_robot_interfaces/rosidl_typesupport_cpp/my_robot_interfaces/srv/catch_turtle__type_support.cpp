...
static const _CatchTurtle_Event_type_support_symbol_names_t _CatchTurtle_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, CatchTurtle_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_robot_interfaces, srv, CatchTurtle_Event)),
  }
};
...
{
  return &::my_robot_interfaces::srv::rosidl_typesupport_cpp::CatchTurtle_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_robot_interfaces, srv, CatchTurtle_Event)() {
  return get_message_type_support_handle<my_robot_interfaces::srv::CatchTurtle_Event>();
}
...
static const rosidl_service_type_support_t CatchTurtle_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<my_robot_interfaces::srv::CatchTurtle_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<my_robot_interfaces::srv::CatchTurtle_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<my_robot_interfaces::srv::CatchTurtle_Event>(),
