...
#include "rosidl_runtime_c/string.h"  // dubug_message
#include "rosidl_runtime_c/string_functions.h"  // dubug_message
...
bool cdr_serialize_my_robot_interfaces__msg__HardwareStatus(
  const my_robot_interfaces__msg__HardwareStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: dubug_message
  {
    const rosidl_runtime_c__String * str = &ros_message->dubug_message;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
bool cdr_deserialize_my_robot_interfaces__msg__HardwareStatus(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces__msg__HardwareStatus * ros_message)
{
  // Field name: temprature
  {
    cdr >> ros_message->temprature;
  ...
  // Field name: dubug_message
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->dubug_message.data) {
      rosidl_runtime_c__String__init(&ros_message->dubug_message);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->dubug_message,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'dubug_message'\n");
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += padding +
    ...
    (ros_message->dubug_message.size + 1);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    is_plain =
      (
      offsetof(DataType, dubug_message) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
bool cdr_serialize_key_my_robot_interfaces__msg__HardwareStatus(
  const my_robot_interfaces__msg__HardwareStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: temprature
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
size_t get_serialized_size_key_my_robot_interfaces__msg__HardwareStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _HardwareStatus__ros_msg_type * ros_message = static_cast<const _HardwareStatus__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
size_t max_serialized_size_key_my_robot_interfaces__msg__HardwareStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const my_robot_interfaces__msg__HardwareStatus * ros_message = static_cast<const my_robot_interfaces__msg__HardwareStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_my_robot_interfaces__msg__HardwareStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  my_robot_interfaces__msg__HardwareStatus * ros_message = static_cast<my_robot_interfaces__msg__HardwareStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_my_robot_interfaces__msg__HardwareStatus(cdr, ros_message);
}
