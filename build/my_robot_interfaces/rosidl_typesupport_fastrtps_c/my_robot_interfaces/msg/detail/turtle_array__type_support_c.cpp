...
bool cdr_serialize_my_robot_interfaces__msg__TurtleArray(
  const my_robot_interfaces__msg__TurtleArray * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: turtles
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
bool cdr_deserialize_my_robot_interfaces__msg__TurtleArray(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces__msg__TurtleArray * ros_message)
{
  // Field name: turtles
  {
    uint32_t cdrSize;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
bool cdr_serialize_key_my_robot_interfaces__msg__TurtleArray(
  const my_robot_interfaces__msg__TurtleArray * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: turtles
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
size_t get_serialized_size_key_my_robot_interfaces__msg__TurtleArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TurtleArray__ros_msg_type * ros_message = static_cast<const _TurtleArray__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
size_t max_serialized_size_key_my_robot_interfaces__msg__TurtleArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const my_robot_interfaces__msg__TurtleArray * ros_message = static_cast<const my_robot_interfaces__msg__TurtleArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_my_robot_interfaces__msg__TurtleArray(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  my_robot_interfaces__msg__TurtleArray * ros_message = static_cast<my_robot_interfaces__msg__TurtleArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_my_robot_interfaces__msg__TurtleArray(cdr, ros_message);
}
